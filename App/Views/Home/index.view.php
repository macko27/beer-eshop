...
<div class="container-fluid">
    <div id="carouselExampleCaptions" class="carousel">
        ...
        <div class="carousel-inner">
            <div class="carousel-item active">
                <img src="public/images/index/pivo.jpg" class="d-block w-100" alt="obrázok piva">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
            <div class="carousel-item">
                <img src="public/images/index/pivo2.jpg" class="d-block w-100" alt="obrázok Zvolena">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
            <div class="carousel-item">
                <img src="public/images/index/pivo3.png" class="d-block w-100" alt="obrázok Zvolena">
                <div class="carousel-caption d-none d-md-block">
                </div>
            </div>
        </div>
    ...
    <main class="index container px-5 py-5">
        <div class="text-center mt-4 mb-4">
            <h1>Pivo z okolia Zvolena</h1>
        </div>

        <div class="text-center mt-4 mb-4">
            <img src="public/images/index/zvolen3.jpg" alt="Obrázek" class="index img-fluid w-25">
        </div>
        ...
        <div class="text-center mt-4 mb-4">
            <a href="<?= $link->url("home.contact") ?>" class="btn btn-custom">Nakupovať</a>
        </div>
    </main>
</div>
